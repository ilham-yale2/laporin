...
<body class="">
    <div class="row mx-0  bg-darkBlue" style="min-height: 100vh;">
        <div class="box-login col-8 col-md-4 radius-10 middle-y">
            <div class="row text-center">
                <div class="p-3 bg-light mx-auto lock">
                    <i class="fas fa-lock fa-3x text-darkGreen"></i>
                </div>
            </div>
            <h2 class="title text-center">Registrasi admin </h2>

            <form class="mt-4" id="formAdmin" action="{{route('admin.handleRegistrasi')}}" method="post">
                {{csrf_field()}}
                <div class="form-group">
                    <label class="text-20 text" for="name">Nama</label>
                    <input class="radius-10 form-control" type="text" id="nama" name="nama">
                </div>
                <div class="form-group">
                ...
                <button class="btn bg-darkGreen title radius-20 py-2 w-100 text-light text-20 mb-3" onclick="registrasi()" type="button">registrasi</button>
            </form>
        </div>
